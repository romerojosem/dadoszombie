  ...
  <body onload="cargaJugadores();setInterval(cargaJugadores, 2000)" role="document">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active" > <a href="/prfinal/salir"> Salir </a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
   ...
   <div class="container theme-showcase" role="main">
      ...
      <div class="jumbotron">
        ...
        <h2 style="font-family: 'Creepster', cursive;">Esperando zombies para comenzar la partida...</h2>
		<div id="lJugadores"></div><br>
		<input id="btnComenzar" type='button' class="btn-success" value='Comenzar Partida' onclick='comenzarPartida()'>
